        ...
        <>
            <div className='card' id='card1'>
                ...
                <div className="image1-wrapper">
                    <img src="/decAbtMe1.png" id="dec1" alt="dec1" />
                    <img src="/abtme1.png" id="abtme1" alt="abtme1" />
                </div>
            </div>
            <div className='card' id='card2'>
                <img src="/abtme2.jpg" id="abtme2" alt="abtme2" />
                <span className='story'>
            ...
            <div className='card' id='card3'>
                ...
                <img src="/abtme3.jpg" id="abtme3" alt="abtme3" />
            </div>
            <div className='card'>
                <div className="image4-wrapper">
                    <img src="/decAbtMe4.png" id="dec4" alt="dec4" />
                    <img src="/decAbtMe4.png" id="dec4-1" alt="dec4-1" />
                    <img src="/abtme4.png" id="abtme4" alt="abtme4" />
                </div>
                <span className='story'>
            ...
            <div className='card' id='card5'>
                ...
                <img src="/abtme5.jpg" id="abtme5" alt="abtme5" />
            </div>
            <div className='card' id='card6'>
                <img src="/abtme6.jpg" id="abtme6" alt="abtme6" />
                <span className='story'>
                    <h2>Little me</h2>
